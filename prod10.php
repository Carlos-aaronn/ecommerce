...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/10.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Semi-Circulum</h2>
            <p class="precio">Precio $85</p>
            <p>Permite una colocación versátil en esquinas o espacios reducidos, maximizando el área de cultivo. Fabricada en cerámica de alta calidad, esta maceta ofrece un acabado suave y elegante que complementa cualquier decoración.</p><br><br>
            <p>Selecciona un color</p>
            <div class="colores">
                <div class="color" style="background-color: black;" data-color="Negro"></div>
                <div class="color" style="background-color: hotpink;" data-color="Rosa"></div>
                <div class="color" style="background-color: purple;" data-color="Morado"></div>
            </div><br>
