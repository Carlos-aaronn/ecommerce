...
<head>
    ...
    <link rel="stylesheet" href="css/pr9.css">
...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/9.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Arco Dorado</h2>
            <p class="precio">Precio $300</p>
            <p>Su forma semicircular permite una disposición atractiva contra paredes o barandales, maximizando el espacio en tu jardín o terraza. Fabricada en material resistente y ligero, esta maceta presenta un acabado suave y moderno.</p><br><br>
