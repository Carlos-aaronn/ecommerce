...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/14.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Massangeana</h2>
            <p class="precio">Precio $550</p>
            <p>Está diseñada especialmente para albergar plantas grandes, permitiendo un desarrollo óptimo de sus raíces. Fabricada con materiales de alta calidad y resistencia, "Massangeana" asegura durabilidad y protección contra las condiciones climáticas adversas.</p><br><br>
            <p>Selecciona un color</p>
            <div class="colores">
                <div class="color" style="background-color: goldenrod;" data-color="Dorado"></div>
                ...
                <div class="color" style="background-color: silver;" data-color="Plateado"></div>
            </div><br>
