...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/13.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Cactus Elegance</h2>
            <p class="precio">Precio $85</p>
            <p>Su forma geométrica no solo resalta la belleza de los cactus, sino que también asegura un drenaje eficiente, evitando el exceso de humedad en el suelo. Fabricada en cerámica de alta calidad, ofrece un acabado suave y moderno que encaja perfectamente en cualquier entorno.</p><br><br>
            ...
            <div class="colores">
                ...
                <div class="color" style="background-color: lightblue;" data-color="Azul"></div>
                <div class="color" style="background-color: grey;" data-color="Gris"></div>
                <div class="color" style="background-color: lightpink;" data-color="Rosa"></div>
            </div><br>
