...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/3.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Geometría Moderna</h2>
            <p class="precio">Precio $369</p>
            <p>Este set de 2, es un elegante adición para cualquier hogar o jardín contemporáneo. Con su diseño minimalista y líneas geométricas limpias, estas macetas añaden un toque de sofisticación y modernidad a tus espacios verdes.</p><br><br>
