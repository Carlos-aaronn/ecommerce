...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/7.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Amor</h2>
            <p class="precio">Precio $165</p>
            <p>La maceta cuenta con un acabado suave y un sistema de colgado robusto que asegura su estabilidad y seguridad. Perfecta para interiores o exteriores, es una opción maravillosa para regalar o para embellecer tu hogar con un toque personal.</p><br><br>
            <p>Selecciona un color</p>
            <div class="colores">
                <div class="color" style="background-color: palevioletred;" data-color="Rojo"></div>
                <div class="color" style="background-color: pink;" data-color="Rosa"></div>
                <div class="color" style="background-color: red;" data-color="Roj"></div>
                <div class="color" style="background-color: saddlebrown;" data-color="Cafe"></div>
            </div><br>
