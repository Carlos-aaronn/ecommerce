...
<body>
    ...
    <div class="contenedor-producto">
        <div class="imagen-producto">
            <img src="img/5.jpeg" alt="Producto">
        </div>
        <div class="detalles-producto">
            <h2>Cuadra tu Mundo</h2>
            <p class="precio">Precio $500</p>
            <p>Este set incluye 2 macetas cuadradas de distintos tamaños, todas ellas con un diseño moderno y minimalista. Las macetas están hechas de materiales duraderos y resistentes, lo que las hace ideales tanto para interiores como exteriores.</p><br><br>
            ...
            <div class="colores">
                ...
                <div class="color" style="background-color: rosybrown;" data-color="Rosy"></div>
            </div><br>
